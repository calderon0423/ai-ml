        ...
        if int(menu_selection) in menu_items.keys():
            ...
            if menu_num.isdigit():
                ...
                if menu_num in menu_items.keys():
                    ...
                    menu_item_name = menu_items[menu_num]["Item name"]
                    
                    # Ask the customer for the quantity of the menu item
                    quantity = input(f"Type the quantity of {menu_item_name} you want to order: ")
                    ...
                    # Tell the customer that their input isn't valid
                        print("Your menu selection is valid.")
...
print(f"This is what we are preparing for you.\n")
