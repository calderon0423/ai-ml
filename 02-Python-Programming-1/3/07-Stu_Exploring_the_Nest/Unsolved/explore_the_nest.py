...
# TODO: Print out the data about the 4th bird in birds_list


# TODO: Calculate the total weight (kg) of all the birds in the birds list


# TODO: Loop through the birds_dictionaries list
