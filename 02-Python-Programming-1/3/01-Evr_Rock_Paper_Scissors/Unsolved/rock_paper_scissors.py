...
# TODO Create a continuous loop so the user can play multiple rounds

    # User Selection
    user_choice = input("Make your Choice: (r)ock, (p)aper, (s)cissors? ")

    # TODO Check if the user selected a valid choice from the options list
        ...
        # TODO: If the user's answer is not "y" or "Y", break from the loop
