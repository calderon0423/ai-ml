...
# TODO: Use a list comprehension to create a list of tuples with the guests for each
# party of guests in the format (adults, children)


# TODO: Use a list comprehension to calculate the total number of adult guests


# TODO: Use a list comprehension to calculate the total number of child guests


# TODO: Use a list comprehension to calculate the total number of guests
