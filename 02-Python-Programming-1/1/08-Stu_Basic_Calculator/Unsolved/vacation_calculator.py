...
print(f"The remaining budget is {remaining_budget:4.2f}.")

# Calculate the remaining budget in local currency amount
local_curr_budget = remaining_budget*exchange_rate
print(f"The remaining budget in local currency is {local_curr_budget:4.2f}")

# Calculate the budget per day in the local currency
daily_budget = local_curr_budget / vacation_days
print(f"The daily budget in local currency is {daily_budget:6.2f}")

# Calculate the budget per day in the local currency, ignoring cents
print(f"The daily budget in local currency is {daily_budget:6.0f}")

# Calculate the total area around the hotel the user can walk within
# Area of a circle = pi * radius ** 2
pi = 3.14159265358979323846
area = pi * distance ** 2
print(f"The total area around the hotel the user can walk within is {area:.2f}")

# Calculate the amount left from the budget if the user sticks with their
# daily budget. This is a modulus problem.
remainder = local_curr_budget % (daily_budget * vacation_days)
print(f"Budget remaining if daily goal met: {remainder}")
